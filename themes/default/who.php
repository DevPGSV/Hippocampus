...
<body>
  ...
  <div id="maincontainer" class="container-fluid">
    <table class="table table-striped table-hover table-condensed table-responsive">
      ...
      <tbody>
          <tr>
              <td><a href="#person-blanca">Blanca</a></td>
              <td>de la Torre Fuertes</td>
              <td><a href="mailto:bldelato@ucm.es">bldelato@ucm.es</a></td>
          </tr>
          <tr>
              <td><a href="#person-marta">Marta</a></td>
              <td>Pastor Puente</td>
              <td><a href="mailto:mapast03@ucm.es">mapast03@ucm.es</a></td>
          </tr>
          <tr>
              <td><a href="#person-guille">Guillermo</a></td>
              <td>Monserrate Sánchez</td>
              <td><a href="mailto:gmonserr@ucm.es">gmonserr@ucm.es</a></td>
          </tr>
          <tr>
              <td><a href="#person-pablo">Pablo</a></td>
              <td>García de los Salmones Valencia</td>
              <td><a href="mailto:pablga05@ucm.es">pablga05@ucm.es</a></td>
          </tr>
          <tr>
              <td><a href="#person-ivan">Iván</a></td>
              <td>Gulyk</td>
              <td><a href="mailto:igulyk@ucm.es">igulyk@ucm.es</a></td>
          </tr>
      </tbody>
    </table>

    <div class="persondata">
      <h1 id="person-blanca">Blanca de la Torre Fuertes</h1>
      <h4>
    ...
    <div class="persondata">
        <h1 id="person-marta">Marta Pastor Puente</h1>
      <h4>
      ...
      <p>
          ...
          En mi tiempo libre me gusta practicar vela ligera y leer poesía.
      </p>
    </div>

    <div class="persondata">
        <h1 id="person-guille">Guillermo Monserrate Sánchez</h1>
      <h4>
      ...
      <p>
          ...
          Lo que más me gusta es poder ver cómo avanzo en cuanto a mi aprendizaje, estando cada vez más cerca de cumplir mis proyectos.

      </p>
    </div>

    <div class="persondata">
        <h1 id="person-pablo">Pablo García de los Salmones Valencia</h1>
      <h4>
      ...
      <p>
        ...
        En mis ratos libres leo, patino e investigo sobre temas de mi interés.
      </p>
    </div>

    <div class="persondata">
        <h1 id="person-ivan">Iván Gulyk</h1>
      <h4>
